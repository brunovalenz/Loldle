...
<div tabindex="0" onclick="closeSidebar()" class="content" id="content">  
    ...
    <div class="container">
        <div class="tblConteiner">
            ...
            <form action="{{route('regiao.index')}}" methood="POST">
                @csrf
                <div class="pesquisar">
                    ...
                    <div class="qntLimpar">
                        ...
                        <a type="button" class="" href="{{ route ('regiao.index')}}">
                            Limpar pesquisa
                            <i class=""></i>   
                        </a>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-lable="Editar">
                                <a class="btnEdit" type="button" href="{{ route('regiao.edit', $registro->id) }}">
                            ...
                            <td data-lable="Deletar">
                                <a class="btnExcluirAction" type="button" href="{{ route('regiao.delete', $registro->id) }}">
