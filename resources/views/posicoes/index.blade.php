...
<div tabindex="0" onclick="closeSidebar()" class="content" id="content">  
    ...
    <div class="container">
        <div class="tblConteiner">
            ...
            <form action="{{route('posicoes.index')}}" methood="POST">
                @csrf
                <div class="pesquisar">
                    ...
                    <div class="qntLimpar">
                        ...
                        <a type="button" class="" href="{{ route ('posicoes.index')}}">
                            Limpar pesquisa
                            <i class=""></i>   
                        </a>
                    </div>
                ...
                <table class ="tbl" id="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td data-lable="Posicao">{{ $registro->posicao}}</td>
                            <td data-lable="Editar">
                                <a class="btnEdit" type="button" href="{{ route('posicoes.edit', $registro->id) }}">
                            ...
                            <td data-lable="Deletar">
                                <a class="btnExcluirAction" type="button" href="{{ route('posicoes.delete', $registro->id) }}">
