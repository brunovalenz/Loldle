...
<div tabindex="0" onclick="closeSidebar()" class="content" id="content">  
    ...
    <div class="container">
        <div class="tblConteiner">
            ...
            <form action="{{route('recurso.index')}}" methood="POST">
                @csrf
                <div class="pesquisar">
                    ...
                    <div class="qntLimpar">
                        ...
                        <a type="button" class="" href="{{ route ('recurso.index')}}">
                            Limpar pesquisa
                            <i class=""></i>   
                        </a>
                    </div>
                ...
                <table class ="tbl" id="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td data-lable="Recurso">{{ $registro->recurso}}</td>
                            <td data-lable="Editar">
                                <a class="btnEdit" type="button" href="{{ route('recurso.edit', $registro->id) }}">
                            ...
                            <td data-lable="Deletar">
                                <a class="btnExcluirAction" type="button" href="{{ route('recurso.delete', $registro->id) }}">
