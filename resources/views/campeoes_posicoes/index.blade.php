...
<div tabindex="0" onclick="closeSidebar()" class="content" id="content">  
    ...
    <div class="containerCamp">
        <div class="tblConteiner">
            <h2> Cadastro de Campeões + Posições</h2>
                ...
                <table class ="tbl" id="table">
                    ...
                    <tbody>
                        @foreach($registros as $registro)
                            ...
                            <td data-lable="Campeão">{{ $registro->campeoes_idcampeoes}}</td>
                            <td data-lable="Posição">{{ $registro->campeao->nome}}</td>
                            <td data-lable="ID Posição">{{ $registro->posicoes_idposicoes}}</td>
                            <td data-lable="ID Posição">{{ $registro->posicao->posicao}}</td>
