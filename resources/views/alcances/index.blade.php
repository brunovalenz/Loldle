...
<div tabindex="0" onclick="closeSidebar()" class="content" id="content">  
    ...
    <div class="container">
        <div class="tblConteiner">
            <h2> Cadastro de Alcances</h2>
            
            <form action="{{route('alcances.index')}}" methood="POST">
                @csrf
                <div class="pesquisar">
                    ...
                    <div class="qntLimpar">
                        ...
                        <a type="button" class="" href="{{ route ('alcances.index')}}">
                            Limpar pesquisa
                            <i class=""></i>   
                        </a>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-lable="Editar">
                                <a class="btnEdit" type="button" href="{{ route('alcances.edit', $registro->id) }}">
                            ...
                            <td data-lable="Deletar">
                                <a class="btnExcluirAction" type="button" href="{{ route('alcances.delete', $registro->id) }}">
