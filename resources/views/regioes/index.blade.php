...
<div tabindex="0" onclick="closeSidebar()" class="content" id="content">  
    ...
    <div class="container">
        <div class="tblConteiner">
            ...
            <form action="{{route('regioes.index')}}" methood="POST">
                @csrf
                <div class="pesquisar">
                    ...
                    <div class="qntLimpar">
                        ...
                        <a type="button" class="" href="{{ route ('regioes.index')}}">
                            Limpar pesquisa
                            <i class=""></i>   
                        </a>
                    </div>
                ...
                <table class ="tbl" id="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td data-lable="Região">{{ $registro->regiao}}</td>
                            <td data-lable="Editar">
                                <a class="btnEdit" type="button" href="{{ route('regioes.edit', $registro->id) }}">
                            ...
                            <td data-lable="Deletar">
                                <a class="btnExcluirAction" type="button" href="{{ route('regioes.delete', $registro->id) }}">
